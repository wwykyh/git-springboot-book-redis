...
<!--market updates updates-->
	...
	<form class="form-horizontal" role="form" action="doEdit" method="post" enctype="multipart/form-data">
	<input type="hidden" name="bookId" value="${ book.bookId}">
  <div class="form-group">
    <label for="firstname" class="col-sm-2 control-label" >书名</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" name ="bookName" id="bookName" value="${ book.bookName}" readonly="readonly">
    </div>
  </div>
  <div class="form-group">
    <label for="lastname" class="col-sm-2 control-label">书本类型</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" name="bookTypename"id="bookTypename" value="${ book.category.typeName}" readonly="readonly">
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="bookAuthor"id="bookAuthor"  value="${ book.bookAuthor}" readonly="readonly">
    </div>
    </div>
    <div class="form-group">
    <label for="lastname" class="col-sm-2 control-label">出版社</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" name="bookEdition"id="bookEdition"value="${ book.bookEdition}"  readonly="readonly">
    </div>
    </div>
    <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="bookAmount"id="bookAmount" value="${ book.bookAmount}">
    </div>
    </div>
    <div class="form-group">
    <label for="lastname" class="col-sm-2 control-label">详细信息</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" name="bookIntroduce"id="bookIntroduce" value="${ book.bookIntroduce}"  >
    </div>
    </div>
    <div class="form-group">
    <label for="lastname" class="col-sm-2 control-label">封面</label>
    <div class="col-sm-10">
<%--       <input type="text" class="form-control" name="bookImages"id="bookImages" value="${ book.bookImages}">
 --%>    
 <img height="100px" width="60"
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="bookSpecil"id="bookSpecil" value="${ book.bookSpecil}" placeholder="0不是特色书籍，1是特色书籍">
    </div>
    </div>
    <div class="form-group">
    <label for="lastname" class="col-sm-2 control-label">折扣</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" name="bookDiscount"id="bookDiscount" value="${ book.bookDiscount}" >
    </div>
