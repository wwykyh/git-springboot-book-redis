...
<!--market updates updates-->
	...
	<form class="form-horizontal" role="form" action="doaddtype" method="post" enctype="multipart/form-data">
	<%-- <input type="hidden" name="bookId" value="${ book.bookId}"> --%>
  <div class="form-group">
    <label for="firstname" class="col-sm-2 control-label" >书籍类型</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" name ="typeName" id="typeName" placeholder="书籍类型">
    </div>
  </div>
  <div class="form-group">
    <label for="lastname" class="col-sm-2 control-label">类型介绍</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" name="typeIntroduce"id="typeIntroduce" placeholder="类型介绍">
    </div>
  </div>
