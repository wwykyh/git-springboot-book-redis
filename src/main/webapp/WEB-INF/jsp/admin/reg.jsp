		...
		<div class="center_content">
					...
					<div class="contact_form">
						<div class="container">
							<div class="row">
								...
								<div class="form_subtitle">创建账户</div>
								<form name="register" action="doreg" method="post"
										...
										<div class="form-group">
											...
											<div class="col-md-6">
												<input type="text" class="contact_input form-control"
													id="username" name="userName" onblur="checkUserName()" />
											</div>
											<div class="col-md-4">
                    ...
                    <input type="text" class="contact_input" />
									...
									<div class="form_row">
										<label class="contact"><strong>Adrres:</strong></label> <input
											type="text" class="contact_input" name="userAdress" />
									</div>
        	...
        	<form action="search" method="get">
              ...
              <div class="cart">
                  ...
                  3 x items | <span class="red">总价: 100$</span>
                  </div>
             ...
             <div class="right_box">
             	...
             	<div class="title"><span class="title_icon"><img src="images/bullet4.gif" alt="" title="" /></span>促销活动</div> 
					...
					<div class="new_prod_box">
						<a href="details">${count.bookName }</a>
