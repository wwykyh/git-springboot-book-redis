							...
							<!--search-box-->
								<div class="search-box">
									...
									<option value="11">11</option>
										...
										<input type="text" placeholder="垵书名查询" required="" name="search">	
...
<!--market updates updates-->
	...
	<table>
	 ...
	 <tr>
      ...
      <th width="130">价格</th>
      <th width="100">库存</th><!-- 
      <th width="130">详细信息</th> -->
      <th width="130">出版日期</th>
      <th width="130">封面</th>
     
      <th width="130">特色书籍</th>
      <th width="130">折扣</th>
       <th style="text-align:center" width="130"> </th>
    </tr>
    
     <c:forEach items="${books }" var="book">
    <tr>
      <td>${book.bookName }</td>
      <td>${book.category.typeName }</td>
      <td>${book.bookAuthor }</td>
      <td>${book.bookEdition }</td>
      <td>${book.bookPrice }</td>
      <td>${book.bookAmount }</td>
      
      <td>${book.issuanceDate }</td>
      
      <td><img height="100px" width="60"
								src="../bookImage/${book.bookImages }" alt="" title="" border="0" />  </td>
      <td>${book.bookSpecil }</td>
      <td>${book.bookDiscount }</td>
      <td><a href="xiugai?id=${book.bookId }"><button type="button" style="background-color:#4DFFFF;width: 76px;height: 36px;color: #FFFFFF" >修改</button></a></td> 
     <td><a onClick="return confirm('确定删除吗?');" href="delete?id=${book.bookId }"><button type="button" style="background-color: black;width: 76px;height: 36px;color: #FFFFFF" >删除</button></a></td> 
    </tr>
   </c:forEach>
    ...
    <div class="sidebar-menu">
		    ...
		    <div class="menu">
		      ...
		      <!--   <li id="menu-academico" ><a href="#"><i class="fa fa-file-text"></i><span>登陆</span><span class="fa fa-angle-right" style="float: right"></span></a>
		       ...
		       <!--  <li><a href="login"><i class="fa fa-file-text"></i><span>登陆</span></a></li> -->
		        <li><a href="/admin/liuyan"><i class="fa fa-bar-chart"></i><span>留言管理</span></a></li>
