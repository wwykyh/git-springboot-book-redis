        	...
        	<div class="feat_prod_box_details">
                ...
                <div class="prod_det_box">
                    ...
                    <%String user = (String)session.getAttribute("username");
                    	if(user!=null){%>
					<a onClick="return confirm('确定添加至购物车吗?');" href="/addcar?bookid=${book.bookId}&userid=${sessionScope.userid }" class="more"><img src="images/order_now.gif" alt="" title="" border="0" /></a>
					<%} else{ %>
				<a href="/myaccount" class="more" onclick="javascript:fun()"><img src="images/order_now.gif" alt="" title="" border="0" /></a>
					<%} %>
                    <div class="clear"></div>
                    </div> 
