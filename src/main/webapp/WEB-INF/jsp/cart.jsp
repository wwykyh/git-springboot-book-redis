...
<div id="wrap">
       ...
       <div class="center_content">
       	<div class="left_content">
        	...
        	<strong>${requestScope.tip}</strong>
            <table class="cart_table">
            	...
            	<tr>
                	<td><a href="details"><img height="60px" width="40px" src="bookImage/${cars.car_Images }" alt="" title="" border="0" class="cart_thumb" /></a></td>
                	<td>${cars.car_Bookname}
                		<input type="hidden" name="bookid" value="${cars.car_Bookid }"></input>
                	</td>
                    <td>${cars.car_Price}</td>
                    <td>
                    <a href="/change?bookid=${cars.car_Bookid }&cz=1" class="checkout" style="width:15px; heigth:15px;">+</a>
					<br/>${cars.car_Number}
                  <a href="/change?bookid=${cars.car_Bookid }&cz=2" class="checkout" style="width:15px; heigth:15px;">-</a>
<%--                     	<input type="hidden" id="n" value="${cars.car_Number}"/>
                    	<input type="hidden" id="price" value="${cars.car_Price}"/>
                    	<input type="hidden" id="number" value="${cars.car_Number}"/> --%>
                    </td>
                    <td>${cars.car_Total}</td>
                    <td><a onClick="return confirm('确定删除吗?');" href="/deleteCar?bookid=${cars.car_Bookid }" class="checkout">删除</a></td>               
                </tr>          
			</c:forEach>
                <tr>
                <td colspan="4" class="cart_total"><span class="red">运费:</span></td>
                <td> <input type="text" id="yf" name="yunfei" value="${yunfei}" style="width:40px;" readonly/></td>                
                </tr>  
                
                <tr>
                <td colspan="4" class="cart_total"><span class="red">总价:</span></td>
                <td> <input type="text" id="total" name="total" value="${Total}" style="width:40px;" readonly/> </td>                
                </tr>                  
            
            </table>
            <a href="/index" class="continue">&lt; 继续</a>
            <a onClick="return confirm('确定购买吗?');" href="/shop" class="checkout">结账 &gt;</a>
