       	...
       	<div class="left_content">
            ...
            <table class="cart_table">
            	...
            	<tr>
                    ...
                    <td>
                    <a href="/Book/change?bookid=${cars.car_Bookid }&cz=1" class="checkout" style="width:15px; heigth:15px;">+</a>
					<br/>${cars.car_Number}
                  <a href="/Book/change?bookid=${cars.car_Bookid }&cz=2" class="checkout" style="width:15px; heigth:15px;">-</a>
<%--                     	<input type="hidden" id="n" value="${cars.car_Number}"/>
                    ...
                    <td><a onClick="return confirm('确定删除吗?');" href="/Book/deleteCar?bookid=${cars.car_Bookid }" class="checkout">删除</a></td>               
                </tr>          
			</c:forEach>
                <tr>
