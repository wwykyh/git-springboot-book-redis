					...
					<div class="header-left">
							...
							<!--search-box-->
								<div class="search-box">
									<form method="post" action="adminsearchType">
									<!-- <select name="type">
									<option value="11">11</option>
									</select><br> -->
										<input type="text" placeholder="垵类型搜索" required="" name="search">	
...
<!--market updates updates-->
    ...
    <tr>
      ...
      <td><a href="updatetype?id=${type.typeId }"><button type="button" style="background-color:#4DFFFF;width: 76px;height: 36px;color: #FFFFFF" >修改</button></a></td> 
     <td><a onClick="return confirm('确定删除吗?');" href="deletetype?id=${type.typeId }"><button type="button" style="background-color: black;width: 76px;height: 36px;color: #FFFFFF" >删除</button></a></td> 
    </tr>
   </c:forEach>
