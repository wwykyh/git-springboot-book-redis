					...
					<div class="header-left">
							...
							<!--search-box-->
								<div class="search-box">
									<form method="post" action="adminsearchMessage">
									<!-- <select name="type">
									<option value="11">11</option>
									</select><br> -->
										<input type="text" placeholder="垵留言搜索" required="" name="search">	
...
<table style="width:100%;border:1px white solid">  
	...
	<tr bgcolor="black"style="color: #fff;">  
	 	<td>${messages.messageName }</td>
 		<td>${messages.messagePhone }</td>
 		<td>${messages.messageEmail }</td>
 		<td>${messages.messageAddress }</td>
 		<td width="600px">${messages.message }</td>
 		<td><a onClick="return confirm('确定删除吗?');" href="/Book/deleteMassage?messageid=${messages.messageId }" class="checkout">删除</a></td>
 	</tr>
	</c:forEach>
</table>  
